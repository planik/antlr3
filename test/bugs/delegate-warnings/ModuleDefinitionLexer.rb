...
module ModuleDefinition
  ...
  class Lexer < ANTLR3::Lexer
    ...
    RULE_NAMES   = %w[T__12 T__13 T__14 T__15 WS BLOCK_COMMENT
                      LINE_COMMENT DEC_NUMBER HEX_NUMBER ID CID
                      IdTail].freeze
    RULE_METHODS = %i[t__12! t__13! t__14! t__15! ws! block_comment!
                      line_comment! dec_number! hex_number! id! cid!
                      id_tail!].freeze
    ...
    def line_comment!
      ...
      while true # decision 2
        ...
        alt_2 = 1 if look_2_0.between?(0x0, 0x9) || look_2_0.between?(0xb, 0xc) || look_2_0.between?(0xe, 0xffff)
        case alt_2
        when 1
          # at line 9:21: ~ ( '\\n' | '\\r' )
    ...
    def dec_number!
      ...
      while true
        ...
        alt_4 = 1 if look_4_0.between?(0x30, 0x39)
        case alt_4
        when 1
          # at line 11:14: '0' .. '9'
    ...
    def hex_number!
      ...
      while true
        ...
        alt_5 = 1 if look_5_0.between?(0x30, 0x39) || look_5_0.between?(0x41, 0x46) || look_5_0.between?(0x61, 0x66)
        case alt_5
        when 1
          # at line
    ...
    def id_tail!
      ...
      while true # decision 6
        ...
        if look_6_0.between?(0x30,
                             0x39) || look_6_0.between?(0x41, 0x5a) || look_6_0 == 0x5f || look_6_0.between?(0x61, 0x7a)
          alt_6 = 1
