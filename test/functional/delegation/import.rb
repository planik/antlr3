...
class TestImportedGrammars < ANTLR3::Test::Functional
  ...
  example 'lots of imported lexers' do
    ...
    MasterOfAll::Lexer.imported_grammars.should
    Set[:FirstSlave, :SecondSlave]
    MasterOfAll::Lexer.master.should be_nil

    MasterOfAll::FirstSlave.master_grammars.should
    MasterOfAll::FirstSlave.imported_grammars.should
    Set[:SlaveOfSlaves]
    MasterOfAll::FirstSlave.master.should

    MasterOfAll::SecondSlave.master_grammars.should
    MasterOfAll::SecondSlave.imported_grammars.should
    Set[]
    MasterOfAll::SecondSlave.master.should

    MasterOfAll::FirstSlave::SlaveOfSlaves.master_grammars.should
    MasterOfAll::FirstSlave::SlaveOfSlaves.imported_grammars.should
    Set[]
    MasterOfAll::FirstSlave::SlaveOfSlaves.master.should
