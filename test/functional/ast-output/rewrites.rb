...
class TestASTViaRewriteRules < ANTLR3::Test::Functional
  def parse(grammar, rule, input, expect_errors = false)
    ...
    grammar_module::Lexer.include ANTLR3::Test::CollectErrors
    grammar_module::Lexer.include ANTLR3::Test::CaptureOutput
    grammar_module::Parser.include ANTLR3::Test::CollectErrors
    grammar_module::Parser.include ANTLR3::Test::CaptureOutput
    ...
    (expect_errors ? [result, parser.reported_errors] : result)
  end
  ...
  def tree_parse(grammar, tree_grammar, rule, tree_rule, input)
    ...
    grammar_module::Parser.include ANTLR3::Test::CollectErrors
    grammar_module::Parser.include ANTLR3::Test::CaptureOutput
    tree_grammar_module::TreeParser.include ANTLR3::Test::CollectErrors
    tree_grammar_module::TreeParser.include ANTLR3::Test::CaptureOutput
