...
class TestASTConstructingParser < ANTLR3::Test::Functional
  ...
  ast_test input: 'public int gnurz = 1 + 2;', rule: :r31, ast: '(VARIABLE gnurz public int (+ 1 2))',
           flag: 1
  ...
  ast_test input: 'public class gnurz extends bool implements int, bool { fooze fooze2 }', rule: :r34,
           ast: '(class gnurz public (extends bool) (implements int bool) fooze fooze2)'
