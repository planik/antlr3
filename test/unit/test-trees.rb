...
class TestTreeNodeStream < Test::Unit::TestCase
  ...
  def test_two_children_of_nil_root
    ...
    root_0.child_index.should
    t.child_index.should
  ...
  def nodes_only_string(nodes)
    ...
    nodes.size.times do |index|
      ...
      buffer << type.to_s unless [DOWN, UP].include?(type)
    end
    buffer.join(' ')
  end
...
class TestCommonTree < Test::Unit::TestCase
  ...
  def test_list
    ...
    assert_nil r0.parent
    r0.child_index.should
    c0.parent.should
    c0.child_index.should
    c1.parent.should
  ...
  def test_list2
    ...
    root.child_index.should
    c0.parent.should
    c0.child_index.should
    c1.parent.should            # NOTE: -- actual python tests all use c0 here, which i think might be wrong
    c1.child_index.should
    c2.parent.should            # NOTE: -- actual python tests all use c0 here, which i think might be wrong
    c2.child_index.should == 2
  end
