  ...
  module Template
    ...
    module GroupFile
      ...
      class Parser < ANTLR3::Parser
        ...
        RULE_METHODS = %i[group_spec group_name member parameter_declaration
        ...
        def unescape(text)
          text.gsub(/\\(?:([abefnrstv])|([0-7]{3})|x([0-9a-fA-F]{2})|(.))/) do
            ...
            elsif ::Regexp.last_match(3) then ::Regexp.last_match(3).to_i(16).chr
            elsif ::Regexp.last_match(4) then ::Regexp.last_match(4)
            end
          end
        end
        ...
        def member(group)
          ...
          begin
            ...
            alt_5 = 1 if look_5_0 == ID || look_5_0 == T__14 || look_5_0.between?(T__17, T__18)
            case alt_5
            when 1
        ...
        def parameter_declaration
          ...
          begin
            ...
            when 1
              ...
              alt_7 = 1 if look_7_0 == ID || look_7_0.between?(T__17, T__18)
              case alt_7
              when 1
