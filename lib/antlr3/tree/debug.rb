...
module ANTLR3
  module Debug
    ...
    # rdoc ANTLR3::Debug::TreeNodeStream
    #
    ...
    class TreeNodeStream
      ...
      #   This actually differs with reset in CommonTreeNodeStream -- why is this one blank?
      #   def reset
      #     # do nothing
      #   end
    end
